...
--wait-for-files /storage/hpc/group/bilyeu/nad7wf/allele_atlas_pipeline/.snakemake/tmp.uz22jsgf results/Preformat_RP_Chr06.vcf.gz --latency-wait 180 \
...
--mode 2  --use-conda  && touch /storage/hpc/group/bilyeu/nad7wf/allele_atlas_pipeline/.snakemake/tmp.uz22jsgf/5.jobfinished || (touch /storage/hpc/group/bilyeu/nad7wf/allele_atlas_pipeline/.snakemake/tmp.uz22jsgf/5.jobfailed; exit 1)
