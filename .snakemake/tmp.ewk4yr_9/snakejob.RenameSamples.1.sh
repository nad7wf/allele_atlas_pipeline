...
--wait-for-files /storage/hpc/group/bilyeu/nad7wf/allele_atlas_pipeline/.snakemake/tmp.ewk4yr_9 resources/RP/RP_Chr01.vcf.gz resources/RP/RP_sample_name_correspondence_file.txt /storage/hpc/group/bilyeu/nad7wf/allele_atlas_pipeline/.snakemake/conda/b21b0d43 --latency-wait 180 \
...
--mode 2  --use-conda  && touch /storage/hpc/group/bilyeu/nad7wf/allele_atlas_pipeline/.snakemake/tmp.ewk4yr_9/1.jobfinished || (touch /storage/hpc/group/bilyeu/nad7wf/allele_atlas_pipeline/.snakemake/tmp.ewk4yr_9/1.jobfailed; exit 1)
