rule SNPEff:
	input:
		...
		eff_jar = "/scratch/nad7wf/miniconda/pkgs/snpeff-5.0-hdfd78af_1/share/snpeff-5.0-1/snpEff.jar",
		eff_config = "/scratch/nad7wf/miniconda/pkgs/snpeff-5.0-hdfd78af_1/share/snpeff-5.0-1/snpEff.config",
	...
	output:
		#one_per = expand("results/SNPEff_{RP_id}_{NRP_id}_Chr{{chr}}.vcf", RP_id = RP_ID, NRP_id = NRP_ID),
